...
const DEFAULT_MEMBERS: TeamMember[] = [
  {
    ...
    image:
      "/ignacy.jpg",
    social: { linkedin: "https://www.linkedin.com/in/ignacywie", website: "https://ignacy.wie.dev" },
  },
  {
    id: "1",
    name: "Mateusz",
  ...
  },
  {
    ...
    image:
      "/honza.jpg",
    social: { linkedin: "https://www.linkedin.com/in/honzakocourek", website: "https://oof2win2.dev/" },
  },
];
...
export default function TeamShowcase({ members = DEFAULT_MEMBERS }: TeamShowcaseProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-8 md:gap-10 lg:gap-14 select-none w-full max-w-5xl mx-auto py-8 px-4 md:px-6 font-sans">
      {/* ── Left: photo grid ── */}
